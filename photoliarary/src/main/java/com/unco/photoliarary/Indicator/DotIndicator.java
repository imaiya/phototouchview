package com.unco.photoliarary.Indicator;
...
import com.unco.photoliarary.R;
...
public class DotIndicator extends View {
    ...
    private int upLimit = 10;//极限数量,当总数量大于该数量时,将使用1/9的形式展示
    ...
    public DotIndicator(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            int fillColor = a.getColor(
                    R.styleable.DotIndicator_fillColor, 0xFFFFFFFF);
            int strokeColor = a.getColor(
                    R.styleable.DotIndicator_strokeColor, 0xFFFFFFFF);
            // Retrieve the radius
            radius = (int) a.getDimension(
                    R.styleable.DotIndicator_radius, radius);
            circleInterval = (int) a.getDimension(
                    R.styleable.DotIndicator_circleInterval, radius);
